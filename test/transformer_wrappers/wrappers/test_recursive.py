...
class TestParallelModelWrapper(unittest.TestCase):
    def test_gpt2_forward_no_recursion(self):
        transformer = 'gpt2'
        ...
        model = RecursiveModelWrapper.from_pretrained(transformer)
...
class TestParallelModelWrapperForCausalLMWrapper(unittest.TestCase):
    def test_gpt2_generate_no_recursion(self):
        transformer = 'gpt2'
        input_string = 'Hello, World!\n'
        ...
        model = RecursiveModelWrapperForCausalLMWrapper.from_pretrained(transformer)
        input_encodings = model.tokenizer(input_string, return_tensors='pt')
