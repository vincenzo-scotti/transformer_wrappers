# TODO extend model API https://github.com/EleutherAI/lm-evaluation-harness/blob/main/lm_eval/api/model.py
# TODO Register model https://github.com/EleutherAI/lm-evaluation-harness/blob/main/lm_eval/api/registry.py#L34

from lm_eval.api.registry import register_model
from lm_eval.models.huggingface import HFLM


@register_model("hfw-auto", "hfw", "huggingfacewrapper")
class HFWLM(HFLM):
    """
